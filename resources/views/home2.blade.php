        ...
        <div class="form-content">
            <form id="create" action="{{url('store')}}" method="POST">
                ...
                <div class="form-group{{ $errors->has('name') ? ' has-error' : "" }}">
                    <input type="text" style="-webkit-appearance: none;" name="name" class="form-control form-input" value="{{Request::old('name')}}"
                           placeholder="الاسم">
                </div>
                <div class="row">
            ...
            {{--    <div class="form-group{{ $errors->has('service') ? ' has-error' : "" }}">
                    ...
                    <div class="form-group{{ $errors->has('service') ? ' has-error' : "" }}">
                        <textarea id="style-1" style="-webkit-appearance: none;" name="service" type="text" class="form-control form-text"
                                  placeholder="أكتب شيئأ">{{Request::old('service')}}</textarea>
                    </div>
                </div>--}}
                <div class="form-group{{ $errors->has('service') ? ' has-error' : "" }}">
